...
//Combinig various flags together
#define GPIO_INPUT_PP				0x00u
#define GPIO_INPUT_OD 			0x10u

#define	GPIO_OUTPUT_MODE 		0x01u
//Combinig various flags together
#define GPIO_OUTPUT_PP			0x01u
#define GPIO_OUTPUT_OD			0x11u

#define GPIO_ALTERNATE_MODE 0x02u
//Combinig various flags together
#define GPIO_AF_PP					0x02u
#define GPIO_AF_OD					0X12u
