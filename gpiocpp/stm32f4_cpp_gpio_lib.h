#ifndef __STM32F_GPIO_CPP_LIB_H__
#define __STM32F_GPIO_CPP_LIB_H__
...
class GPIO{
	...
	public:
		GPIO(PORT_NameType name_obj,GPIO_Typedef *GPIOx,GPIO_InitTypeDef *GPIO_Init);
		...
		//this is my own stuff below
		void LIB_GPOIX_CLK_ENABLE(PORT_NameType *GPIO_port);
